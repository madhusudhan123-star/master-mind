...
function LearningLabContent() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const confirmed = window.confirm(`20 questions have been generated successfully! Would you like to view them now?`);
            
            if (confirmed) {
                navigate(`/practice-test/${generatedQuestions.id}`, { 
